...
const u8 gText_MainMenuMysteryEvents[] = _("Myster Events");
...
const u8 gText_Rat[] = _("So you want a RAT?");
...
const u8 gText_TurnRepellantOff[] = _("Turn off PokeRepellant?");
const u8 gText_TurnRepellantOn[] = _("Turn on PokeRepellant?");
...
const u8 gText_BattleItemsPocket[] = _("Held Items");
