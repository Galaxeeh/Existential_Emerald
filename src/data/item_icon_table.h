const u32 *const gItemIconTable[ITEMS_COUNT + 1][2] =
{
    ...
    // Pokevial Branch
    [ITEM_POKEVIAL] = {gItemIcon_PowderJar, gItemIconPalette_PowderJar},
    //Candy Dust
    [ITEM_CANDY_DUST] = {gItemIcon_MetalPowder, gItemIconPalette_MetalPowder},
    [ITEM_POKEREPELLANT] = {gItemIcon_Repel, gItemIconPalette_MaxRepel},
