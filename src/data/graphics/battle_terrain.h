...
const u32 gBattleTerrainTiles_SnowLongGrass[] = INCBIN_U32("graphics/battle_terrain/snow_long_grass/tiles.4bpp.lz");
const u32 gBattleTerrainPalette_SnowLongGrass[] = INCBIN_U32("graphics/battle_terrain/snow_long_grass/palette.gbapal.lz");
const u32 gBattleTerrainTilemap_SnowLongGrass[] = INCBIN_U32("graphics/battle_terrain/snow_long_grass/map.bin.lz");

const u32 gBattleTerrainAnimTiles_SnowLongGrass[] = INCBIN_U32("graphics/battle_terrain/snow_long_grass/anim_tiles.4bpp.lz");
const u32 gBattleTerrainAnimTilemap_SnowLongGrass[] = INCBIN_U32("graphics/battle_terrain/snow_long_grass/anim_map.bin.lz");
