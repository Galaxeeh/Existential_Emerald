...
#define SAMUROTT_MISC_INFO                                                  \
    ...
    [SPECIES_ROGGENROLA] =
    {
        ...
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_WEAK_ARMOR, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BLUE,
...
#define DARMANITAN_GALARIAN_MISC_INFO                                           \
    ...
    [SPECIES_SCRAGGY] =
    {
        ...
        LEARNSETS(Scraggy),
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_SCRAFTY}),
    },
...
#define SAWSBUCK_MISC_INFO                                                              \
    ...
    [SPECIES_KLINK] =
    {
        ...
        LEARNSETS(Klink),
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_KLANG}),
    },
