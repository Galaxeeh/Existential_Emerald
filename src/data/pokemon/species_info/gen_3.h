...
#define GALLADE_MISC_INFO                                   \
    ...
    [SPECIES_NOSEPASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_MINERAL, EGG_GROUP_MINERAL },
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_MAGNET_PULL, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_GRAY,
...
#define MAWILE_MISC_INFO                                    \
    ...
    [SPECIES_ARON] =
    {
        ...
        LEARNSETS(Aron),
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_LAIRON}),
    },
...
#define AGGRON_MISC_INFO                                        \
    ...
    [SPECIES_AGGRON] =
    {
        ...
        .types = { TYPE_STEEL, TYPE_ROCK },
        .expYield = 239,
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_HEAVY_METAL, ABILITY_STURDY },
        .cryId = CRY_AGGRON,
        .height = 21,
        .weight = 3600,
        .description = COMPOUND_STRING(
...
#define CAMERUPT_MISC_INFO                                  \
    ...
    [SPECIES_TRAPINCH] =
    {
        ...
        LEARNSETS(Trapinch),
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_VIBRAVA}),
    },
...
#define ALTARIA_MISC_INFO                                   \
    ...
    [SPECIES_CORPHISH] =
    {
        ...
        LEARNSETS(Corphish),
        .evolutions = EVOLUTION({EVO_LEVEL, 27, SPECIES_CRAWDAUNT}),
    },
