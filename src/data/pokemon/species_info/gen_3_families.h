...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_GULPIN] =
    {
        ...
        .abilities = { ABILITY_LIQUID_OOZE, ABILITY_LIQUID_OOZE, ABILITY_GLUTTONY },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CACNEA] =
    {
        ...
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_NONE, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_MILOTIC] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_MARVEL_SCALE, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_PINK,
