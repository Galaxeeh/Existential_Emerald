...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_IRON_BARBS, ABILITY_OVERGROW, ABILITY_BULLETPROOF },
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_BLAZE, ABILITY_MAGICIAN },
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_TECHNICIAN, ABILITY_TORRENT, ABILITY_PROTEAN },
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNNERVE, ABILITY_UNNERVE, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_GOGOAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GRASS_PELT, ABILITY_LEAF_GUARD, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_INKAY] =
    {
        ...
        .abilities = { ABILITY_INFILTRATOR, ABILITY_INFILTRATOR, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Inkay"),
        .cryId = CRY_INKAY,
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 38, SPECIES_BARBARACLE}),
    },
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .abilities = { ABILITY_POISON_POINT, ABILITY_ADAPTABILITY, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BROWN,
