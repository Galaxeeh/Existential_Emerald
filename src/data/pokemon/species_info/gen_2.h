...
#define TYPHLOSION_MISC_INFO                                            \
    ...
    [SPECIES_SENTRET] =
    {
        ...
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_PICKPOCKET, ABILITY_KEEN_EYE },
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_MARILL] =
    {
        ...
        LEARNSETS(Marill),
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_AZUMARILL}),
    },
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_TECHNICIAN, ABILITY_SKILL_LINK, ABILITY_SKILL_LINK },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_COMPOUND_EYES, ABILITY_SPEED_BOOST },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Yanma"),
        .cryId = CRY_YANMA,
...
#define WOOPER_MISC_INFO                                                        \
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .abilities = { ABILITY_DAMP, ABILITY_DAMP, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BLUE,
        ...
        ICON(Wooper, 0),
        LEARNSETS(Wooper),
        .evolutions = EVOLUTION({EVO_LEVEL, 17, SPECIES_QUAGSIRE}),
    },
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = { EGG_GROUP_FLYING, EGG_GROUP_FLYING },
        .abilities = { ABILITY_INSOMNIA, ABILITY_INSOMNIA, ABILITY_SUPER_LUCK },
...
#define UNOWN_MISC_INFO(letter)                                         \
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_BUG, EGG_GROUP_BUG },
        .abilities = { ABILITY_STURDY, ABILITY_BATTLE_ARMOR, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_PURPLE,
...
#define DUDUNSPARCE_MISC_INFO(segments)                                             \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                           \
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },                          \
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_SCRAPPY, ABILITY_RATTLED },   \
        .bodyColor = BODY_COLOR_YELLOW,                                             \
...
#define SNEASEL_MISC_INFO                                   \
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_HONEY, SPECIES_URSALUNA},
                                {EVO_ITEM, ITEM_MAX_HONEY, SPECIES_URSALUNA_BLOODMOON}),
    },
...
#define HOUNDOOM_MISC_INFO                                  \
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = { EGG_GROUP_FIELD, EGG_GROUP_FIELD },
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_CUTE_CHARM, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
