...
static const struct TrainerMon sParty_GruntRusturfTunnel[] = {
    ...
    .moves = {MOVE_ASSIST, MOVE_NASTY_PLOT, MOVE_SNARL, MOVE_SUBSTITUTE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 22,
...
static const struct TrainerMon sParty_Dusty1[] = {
    ...
    .moves = {MOVE_STEALTH_ROCK, MOVE_FLAME_CHARGE, MOVE_BULLDOZE, MOVE_ROCK_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAIN_PUNCH, MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_AUTOTOMIZE, MOVE_GEAR_GRIND, MOVE_WILD_CHARGE, MOVE_SUBSTITUTE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_HEAD_SMASH, MOVE_DUAL_WINGBEAT, MOVE_EARTHQUAKE, MOVE_U_TURN}
    }
};
...
static const struct TrainerMon sParty_Dusty4[] = {
    ...
    .nature = NATURE_SASSY,
    .moves = {MOVE_BLOCK, MOVE_DOUBLE_TEAM, MOVE_TOXIC, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    ...
    .nature = NATURE_TIMID,
    .moves = {MOVE_SILVER_WIND, MOVE_OMINOUS_WIND, MOVE_AIR_SLASH, MOVE_FOCUS_BLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_QUICK_ATTACK, MOVE_BULLDOZE, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Dusty5[] = {
    ...
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_SWORDS_DANCE, MOVE_PROTECT, MOVE_BATON_PASS, MOVE_SPIKES}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
...
static const struct TrainerMon sParty_GruntMtChimney1[] = {
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_FLING, MOVE_POISON_JAB, MOVE_EARTHQUAKE, MOVE_ACROBATICS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .nature = NATURE_MODEST,
    .moves = {MOVE_VENOSHOCK, MOVE_BUG_BUZZ, MOVE_PSYCHIC, MOVE_HIDDEN_POWER_ELECTRIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_LOW_SWEEP, MOVE_SUCKER_PUNCH, MOVE_ROCK_SLIDE, MOVE_LEAF_BLADE}
    }
};
...
static const struct TrainerMon sParty_Cole[] = {
    ...
    .nature = NATURE_TIMID,
    .moves = {MOVE_YAWN, MOVE_HYPER_VOICE, MOVE_SNARL, MOVE_HEAT_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_MILD,
    .moves = {MOVE_SEARING_SHOT, MOVE_GRASS_KNOT, MOVE_ACROBATICS, MOVE_BRICK_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_FLAME_CHARGE, MOVE_FACADE, MOVE_TRAILBLAZE, MOVE_DOUBLE_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_MODEST,
    .moves = {MOVE_VOLT_SWITCH, MOVE_THUNDER_WAVE, MOVE_SNARL, MOVE_HYPER_VOICE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
...
static const struct TrainerMon sParty_Jeff[] = {
    ...
    .nature = NATURE_SASSY,
    .moves = {MOVE_OVERHEAT, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_TRAILBLAZE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_FIRE_LASH, MOVE_SUCKER_PUNCH, MOVE_THUNDER_PUNCH, MOVE_BUG_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_SASSY,
    .moves = {MOVE_HEAD_SMASH, MOVE_WOOD_HAMMER, MOVE_FIRE_PUNCH, MOVE_SUCKER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Axle[] = {
    ...
    .nature = NATURE_QUIET,
    .moves = {MOVE_TRICK_ROOM, MOVE_FIRE_BLAST, MOVE_FOCUS_BLAST, MOVE_PSYCHIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
    ...
    .nature = NATURE_QUIET,
    .moves = {MOVE_ANCIENT_POWER, MOVE_EARTH_POWER, MOVE_FLAMETHROWER, MOVE_REST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_QUIET,
    .moves = {MOVE_ERUPTION, MOVE_SOLAR_BEAM, MOVE_EARTH_POWER, MOVE_BODY_PRESS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
    ...
    .nature = NATURE_SASSY,
    .moves = {MOVE_GIGA_DRAIN, MOVE_WEATHER_BALL, MOVE_SPIKY_SHIELD, MOVE_GROWTH}
    }
};
...
static const struct TrainerMon sParty_Keegan[] = {
    ...
    .ability = ABILITY_UNNERVE,
    .nature = NATURE_BOLD,
    .moves = {MOVE_WILL_O_WISP, MOVE_DARK_PULSE, MOVE_SLUDGE_BOMB, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    ...
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_BITTER_BLADE, MOVE_SHADOW_SNEAK, MOVE_POLTERGEIST, MOVE_BRICK_BREAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_BOLD,
    .moves = {MOVE_GIGA_DRAIN, MOVE_FLAMETHROWER, MOVE_LEECH_SEED, MOVE_SUBSTITUTE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_SWAGGER, MOVE_DRAGON_CLAW, MOVE_FLAME_CHARGE, MOVE_BULLDOZE}
    }
};
...
static const struct TrainerMon sParty_Drew[] = {
    ...
    .ability = ABILITY_STORM_DRAIN,
    .nature = NATURE_TIMID,
    .moves = {MOVE_NASTY_PLOT, MOVE_SURF, MOVE_DRAGON_PULSE, MOVE_ICY_WIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
...
static const struct TrainerMon sParty_Beau[] = {
    ...
    .ability = ABILITY_SAND_RUSH,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_BOLT_BEAK, MOVE_LOW_KICK, MOVE_SUBSTITUTE, MOVE_BREAKING_SWIPE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .nature = NATURE_RELAXED,
    .moves = {MOVE_SAND_TOMB, MOVE_BODY_PRESS, MOVE_STONE_EDGE, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_DUAL_WINGBEAT, MOVE_ROCK_SLIDE, MOVE_LASH_OUT, MOVE_FACADE}
    }
};
...
static const struct TrainerMon sParty_Ethan1[] = {
    ...
    .nature = NATURE_BOLD,
    .moves = {MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER_ICE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 34,
    ...
    .ability = ABILITY_TANGLED_FEET,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_BRAVE_BIRD, MOVE_DOUBLE_EDGE, MOVE_DRILL_RUN, MOVE_JUMP_KICK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
    ...
    .nature = NATURE_SASSY,
    .moves = {MOVE_WILL_O_WISP, MOVE_SLACK_OFF, MOVE_FIRE_SPIN, MOVE_MUD_SLAP}
    }
};
...
static const struct TrainerMon sParty_Autumn[] = {
    ...
    .ability = ABILITY_COMPETITIVE,
    .nature = NATURE_TIMID,
    .moves = {MOVE_PSYCHIC, MOVE_ENERGY_BALL, MOVE_ALLURING_VOICE, MOVE_DARK_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_MODEST,
    .moves = {MOVE_QUIVER_DANCE, MOVE_BUG_BUZZ, MOVE_MOONBLAST, MOVE_HIDDEN_POWER_WATER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .ability = ABILITY_SERENE_GRACE,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_BODY_SLAM, MOVE_ZEN_HEADBUTT, MOVE_HORN_LEECH, MOVE_AGILITY}
    }
};
...
static const struct TrainerMon sParty_Travis[] = {
    ...
    .nature = NATURE_BRAVE,
    .moves = {MOVE_EARTHQUAKE, MOVE_FIRE_FANG, MOVE_ROCK_SLIDE, MOVE_BODY_PRESS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_FAKE_OUT, MOVE_NUZZLE, MOVE_ZING_ZAP, MOVE_IRON_HEAD}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .ability = ABILITY_SWARM,
    .nature = NATURE_SASSY,
    .moves = {MOVE_BUG_BITE, MOVE_RISING_VOLTAGE, MOVE_SUBSTITUTE, MOVE_BITE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 15,
    ...
    .ability = ABILITY_TECHNICIAN,
    .nature = NATURE_BRAVE,
    .moves = {MOVE_RAZOR_WIND, MOVE_BUG_BITE, MOVE_LEAFAGE, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .nature = NATURE_RELAXED,
    .moves = {MOVE_PROTECT, MOVE_POISON_GAS, MOVE_SNARL, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 26,
    ...
    .nature = NATURE_MODEST,
    .moves = {MOVE_TOXIC, MOVE_VENOSHOCK, MOVE_FLAME_BURST, MOVE_DRAGON_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 26,
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .ability = ABILITY_LEVITATE,
    .nature = NATURE_MODEST,
    .moves = {MOVE_WILL_O_WISP, MOVE_VOLT_SWITCH, MOVE_OVERHEAT, MOVE_FOUL_PLAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
    ...
    .ability = ABILITY_INTIMIDATE,
    .nature = NATURE_HASTY,
    .moves = {MOVE_MORNING_SUN, MOVE_EXTREME_SPEED, MOVE_OVERHEAT, MOVE_PLAY_ROUGH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_SHADOW_BONE, MOVE_FLAME_CHARGE, MOVE_THUNDER_PUNCH, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .ability = ABILITY_FLAME_BODY,
    .nature = NATURE_BOLD,
    .moves = {MOVE_QUIVER_DANCE, MOVE_BUG_BUZZ, MOVE_FIRE_PLEDGE, MOVE_GIGA_DRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
    ...
    .nature = NATURE_TIMID,
    .moves = {MOVE_MYSTICAL_FIRE, MOVE_SCORCHING_SANDS, MOVE_AIR_SLASH, MOVE_HIDDEN_POWER_GRASS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 37,
    ...
    .ability = ABILITY_CHLOROPHYLL,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_SOLAR_BLADE, MOVE_SWORDS_DANCE, MOVE_KNOCK_OFF, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Jerry1[] = {
    ...
    .moves = {MOVE_DISCHARGE, MOVE_ENERGY_BALL, MOVE_HIDDEN_POWER_DARK, MOVE_EXPLOSION}
    }
};
...
static const struct TrainerMon sParty_Victor[] = {
    ...
    .ability = ABILITY_SERENE_GRACE,
    .nature = NATURE_IMPISH,
    .moves = {MOVE_GLARE, MOVE_HEADBUTT, MOVE_ZEN_HEADBUTT, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .nature = NATURE_CALM,
    .moves = {MOVE_PARABOLIC_CHARGE, MOVE_MUDDY_WATER, MOVE_THUNDER_WAVE, MOVE_SOAK}
    }
};
...
static const struct TrainerMon sParty_Victoria[] = {
    ...
    .nature = NATURE_MODEST,
    .moves = {MOVE_ATTRACT, MOVE_GIGA_DRAIN, MOVE_DRAINING_KISS, MOVE_HIDDEN_POWER_FIRE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_ATTRACT, MOVE_DIG, MOVE_HEADBUTT, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_Vicky[] = {
    ...
    .ability = ABILITY_SHELL_ARMOR,
    .nature = NATURE_CALM,
    .moves = {MOVE_WILL_O_WISP, MOVE_SHELL_TRAP, MOVE_DRAGON_PULSE, MOVE_FIRE_SPIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_WILL_O_WISP, MOVE_PLAY_ROUGH, MOVE_KNOCK_OFF, MOVE_SUBSTITUTE}
    }
};
...
static const struct TrainerMon sParty_Billy[] = {
    ...
    .ability = ABILITY_GUTS,
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_QUICK_ATTACK, MOVE_BITE, MOVE_TACKLE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 8,
...
static const struct TrainerMon sParty_Allen[] = {
    ...
    .nature = NATURE_QUIET,
    .moves = {MOVE_HEADBUTT, MOVE_LEAFAGE, MOVE_CURSE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Maria1[] = {
    ...
    .ability = ABILITY_STURDY,
    .nature = NATURE_RELAXED,
    .moves = {MOVE_TRAILBLAZE, MOVE_HIGH_HORSEPOWER, MOVE_BODY_PRESS, MOVE_STONE_EDGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 25,
    ...
    .ability = ABILITY_SNIPER,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_DRILL_PECK, MOVE_FACADE, MOVE_STEEL_WING, MOVE_QUICK_ATTACK}
    }
};
...
static const struct TrainerMon sParty_Heidi[] = {
    ...
    .nature = NATURE_IMPISH,
    .moves = {MOVE_WILL_O_WISP, MOVE_RAGING_BULL, MOVE_WILD_CHARGE, MOVE_BODY_PRESS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    ...
    .ability = ABILITY_SAND_FORCE,
    .nature = NATURE_BOLD,
    .moves = {MOVE_EARTH_POWER, MOVE_METEOR_BEAM, MOVE_FLASH_CANNON, MOVE_THUNDERBOLT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .ability = ABILITY_SAND_RUSH,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_PHANTOM_FORCE, MOVE_PLAY_ROUGH, MOVE_CRUNCH, MOVE_SHADOW_SNEAK}
    }
};
...
static const struct TrainerMon sParty_Becky[] = {
    ...
    .ability = ABILITY_SAND_RUSH,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_PARTING_SHOT, MOVE_BODY_SLAM, MOVE_PLAY_ROUGH, MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    ...
    .ability = ABILITY_SAND_FORCE,
    .nature = NATURE_MODEST,
    .moves = {MOVE_EARTH_POWER, MOVE_SCALD, MOVE_ANCIENT_POWER, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .ability = ABILITY_LEVITATE,
    .nature = NATURE_BOLD,
    .moves = {MOVE_GRASS_KNOT, MOVE_POWER_GEM, MOVE_PSYCHIC, MOVE_ICE_BEAM}
    }
};
...
static const struct TrainerMon sParty_Diana1[] = {
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_FAKE_OUT, MOVE_TAIL_SLAP, MOVE_U_TURN, MOVE_UPPER_HAND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_U_TURN, MOVE_STRENGTH_SAP, MOVE_LEECH_SEED, MOVE_ACROBATICS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .ability = ABILITY_STORM_DRAIN,
    .nature = NATURE_HASTY,
    .moves = {MOVE_U_TURN, MOVE_FLIP_TURN, MOVE_ICE_BEAM, MOVE_ENCORE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 38,
    ...
    .ability = ABILITY_INTIMIDATE,
    .nature = NATURE_HASTY,
    .moves = {MOVE_PARTING_SHOT, MOVE_U_TURN, MOVE_OVERHEAT, MOVE_CRUNCH}
    }
};
...
static const struct TrainerMon sParty_Irene[] = {
    ...
    .nature = NATURE_TIMID,
    .moves = {MOVE_INSTRUCT, MOVE_TRICK_ROOM, MOVE_FOLLOW_ME, MOVE_NONE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    ...
    .ability = ABILITY_INTIMIDATE,
    .nature = NATURE_MODEST,
    .moves = {MOVE_ENERGY_BALL, MOVE_BUG_BUZZ, MOVE_AIR_SLASH, MOVE_WEATHER_BALL}
    }
};
...
static const struct TrainerMon sParty_BrendanRoute103Rattata[] = {
    ...
    .nature = NATURE_QUIRKY,
    .species = SPECIES_RIOLU,
    .moves = {MOVE_VACUUM_WAVE, MOVE_QUICK_ATTACK, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Isaac1[] = {
    ...
    .nature = NATURE_MODEST,
    .moves = {MOVE_EERIE_IMPULSE, MOVE_VOLT_SWITCH, MOVE_AIR_SLASH, MOVE_FEATHER_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 29,
    ...
    .ability = ABILITY_INTIMIDATE,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_GLARE, MOVE_POISON_JAB, MOVE_LEECH_LIFE, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
...
static const struct TrainerMon sParty_Lydia1[] = {
    ...
    .nature = NATURE_QUIRKY,
    .moves = {MOVE_DRAINING_KISS, MOVE_AURORA_BEAM, MOVE_PSYBEAM, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMon sParty_Julio[] = {
    ...
    .ability = ABILITY_INTIMIDATE,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_WILD_CHARGE, MOVE_PLAY_ROUGH, MOVE_JAW_LOCK, MOVE_ICE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_DIVE, MOVE_BRAVE_BIRD, MOVE_SUBSTITUTE, MOVE_STEEL_WING}
    }
};
...
static const struct TrainerMon sParty_GruntMtChimney2[] = {
    ...
    .ability = ABILITY_LEVITATE,
    .nature = NATURE_BOLD,
    .moves = {MOVE_SPEED_SWAP, MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_POWER_SWAP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_LEECH_LIFE, MOVE_POISON_FANG, MOVE_ACROBATICS, MOVE_SUPER_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    ...
    .ability = ABILITY_TINTED_LENS,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_AXE_KICK, MOVE_U_TURN, MOVE_LASH_OUT}
    } 
};
...
static const struct TrainerMon sParty_BrendanRustboroRattata[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 18,
    ...
    .ability = ABILITY_INNER_FOCUS,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_KARATE_CHOP, MOVE_METAL_CLAW, MOVE_QUICK_ATTACK, MOVE_VACUUM_WAVE}
    }
};

static const struct TrainerMon sParty_MayRustboroRattata[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 18,
    .species = SPECIES_PACHIRISU,
...
static const struct TrainerMon sParty_TabithaMtChimney[] = {
    ...
    .ability = ABILITY_DEFIANT,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_U_TURN, MOVE_PARTING_SHOT, MOVE_FAKE_OUT, MOVE_BODY_SLAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    ...
    .nature = NATURE_BOLD,
    .moves = {MOVE_QUIVER_DANCE, MOVE_GIGA_DRAIN, MOVE_ALLURING_VOICE, MOVE_HIDDEN_POWER_ROCK}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    ...
    .nature = NATURE_TIMID,
    .moves = {MOVE_FAKE_TEARS, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_SIGNAL_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    ...
    .ability = ABILITY_INTIMIDATE,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_FIRE_FANG, MOVE_ICE_FANG, MOVE_THUNDER_FANG, MOVE_THROAT_CHOP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 34,
    ...
    .nature = NATURE_MODEST,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_RECOVER, MOVE_SUBSTITUTE, MOVE_HIDDEN_POWER_GROUND}
    }
};
...
static const struct TrainerMon sParty_MaxieMtChimney[] = {
    ...
    .ability = ABILITY_NO_GUARD,
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_TOXIC, MOVE_ROCK_SLIDE, MOVE_CLOSE_COMBAT, MOVE_PURSUIT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 34,
    ...
    .ability = ABILITY_SUPER_LUCK,
    .nature = NATURE_HASTY,
    .moves = {MOVE_NIGHT_SLASH, MOVE_AIR_CUTTER, MOVE_OMINOUS_WIND, MOVE_HIDDEN_POWER_GROUND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    ...
    .ability = ABILITY_PRESSURE,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_FAKE_OUT, MOVE_AQUA_PUNCH, MOVE_KNOCK_OFF, MOVE_ICE_SPINNER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 34,
    ...
    .ability = ABILITY_STURDY,
    .nature = NATURE_MODEST,
    .moves = {MOVE_RISING_VOLTAGE, MOVE_HIDDEN_POWER_ICE, MOVE_FLASH_CANNON, MOVE_EXPLOSION}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    ...
    .nature = NATURE_TIMID,
    .moves = {MOVE_MOONBLAST, MOVE_VACUUM_WAVE, MOVE_PSYCHIC, MOVE_HIDDEN_POWER_WATER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 33,
    ...
    .nature = NATURE_IMPISH,
    .moves = {MOVE_DRAIN_PUNCH, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_KNOCK_OFF}
    }
};
...
static const struct TrainerMon sParty_Vivi[] = {
    ...
    .ability = ABILITY_LEVITATE,
    .nature = NATURE_TIMID,
    .moves = {MOVE_TOXIC, MOVE_HEX, MOVE_ACID_SPRAY, MOVE_MEGA_DRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    ...
    .ability = ABILITY_UNNERVE,
    .nature = NATURE_BRAVE,
    .moves = {MOVE_VENOSHOCK, MOVE_ATTACK_ORDER, MOVE_HEAL_ORDER, MOVE_AIR_SLASH}
    }
};
...
static const struct TrainerMon sParty_Eric[] = {
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_BODY_PRESS, MOVE_STONE_EDGE, MOVE_HEAT_CRASH, MOVE_WONDER_ROOM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 35,
    ...
    .ability = ABILITY_STATIC,
    .nature = NATURE_BOLD,
    .moves = {MOVE_THUNDERBOLT, MOVE_EARTH_POWER, MOVE_SLUDGE_BOMB, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_Mike1[] = {
    ...
    .nature = NATURE_CALM,
    .moves = {MOVE_SCALD, MOVE_FROST_BREATH, MOVE_POWER_GEM, MOVE_EARTH_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 19,
    ...
    .ability = ABILITY_HYPER_CUTTER,
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_ACROBATICS, MOVE_STOMPING_TANTRUM, MOVE_X_SCISSOR, MOVE_KNOCK_OFF}
    }
};
...
static const struct TrainerMon sParty_Gerald[] = {
    ...
    .ability = ABILITY_FLAME_BODY,
    .nature = NATURE_BOLD,
    .moves = {MOVE_WILL_O_WISP, MOVE_SCORCHING_SANDS, MOVE_FLAMETHROWER, MOVE_HIDDEN_POWER_GRASS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .ability = ABILITY_DEFIANT,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_FIRST_IMPRESSION, MOVE_U_TURN, MOVE_BRAVE_BIRD, MOVE_SOLAR_BLADE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .ability = ABILITY_RECKLESS,
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_FLARE_BLITZ, MOVE_DRAIN_PUNCH, MOVE_WILD_CHARGE, MOVE_KNOCK_OFF}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .ability = ABILITY_FLAME_BODY,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_LEECH_LIFE, MOVE_FIRE_LASH, MOVE_COIL, MOVE_KNOCK_OFF}
    }
};
...
static const struct TrainerMon sParty_Danielle[] = {
    ...
    .ability = ABILITY_IRON_FIST,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_U_TURN, MOVE_FAKE_OUT, MOVE_FIRE_PUNCH, MOVE_MACH_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .ability = ABILITY_CUD_CHEW,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_RAGING_BULL, MOVE_CLOSE_COMBAT, MOVE_EARTHQUAKE, MOVE_SUBSTITUTE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_ZEN_HEADBUTT, MOVE_FIRE_PUNCH, MOVE_DRAIN_PUNCH, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 36,
    ...
    .ability = ABILITY_SHEER_FORCE,
    .nature = NATURE_HASTY,
    .moves = {MOVE_FIRE_FANG, MOVE_BRICK_BREAK, MOVE_ROCK_SLIDE, MOVE_GUARD_SWAP}
    }
};
...
static const struct TrainerMon sParty_WallyMauville[] = {
    ...
    .nature = NATURE_BOLD,
    .moves = {MOVE_PSYCHIC_NOISE, MOVE_DRAINING_KISS, MOVE_CHARM, MOVE_ROUND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 21,
    ...
    .ability = ABILITY_UNNERVE,
    .nature = NATURE_SASSY,
    .moves = {MOVE_HIDDEN_POWER_DARK, MOVE_LEECH_SEED, MOVE_PSYBEAM, MOVE_GRASS_KNOT}
    }
};
...
static const struct TrainerMon sParty_Dawson[] = {
    ...
    .nature = NATURE_CALM,
    .moves = {MOVE_HEX, MOVE_MEGA_DRAIN, MOVE_CONFUSE_RAY, MOVE_SAND_TOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 20,
...
static const struct TrainerMon sParty_Tyron[] = {
    ...
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_MORNING_SUN, MOVE_SOLAR_BLADE, MOVE_PLAY_ROUGH, MOVE_HEAL_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 29,
    ...
    .ability = ABILITY_LEVITATE,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_ROCK_SLIDE, MOVE_FLARE_BLITZ, MOVE_ZEN_HEADBUTT, MOVE_ALLY_SWITCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .ability = ABILITY_WATER_ABSORB,
    .nature = NATURE_CALM,
    .moves = {MOVE_MUDDY_WATER, MOVE_EARTH_POWER, MOVE_TOXIC, MOVE_PROTECT}
    }
};
...
static const struct TrainerMon sParty_Celina[] = {
    ...
    .ability = ABILITY_PRANKSTER,
    .nature = NATURE_IMPISH,
    .moves = {MOVE_SUNNY_DAY, MOVE_FOUL_PLAY, MOVE_TAUNT, MOVE_TAILWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .ability = ABILITY_SOLAR_POWER,
    .nature = NATURE_MODEST,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_EARTH_POWER, MOVE_WEATHER_BALL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 29,
    ...
    .ability = ABILITY_CHLOROPHYLL,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_SEED_BOMB, MOVE_FIRE_FANG, MOVE_CRUNCH, MOVE_FLAMETHROWER}
    }
};
...
static const struct TrainerMon sParty_Bianca[] = {
    ...
    .ability = ABILITY_ADAPTABILITY,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_RETALIATE, MOVE_RETURN, MOVE_ICE_PUNCH, MOVE_PSYCHIC_FANGS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
...
static const struct TrainerMon sParty_Hayden[] = {
    ...
    .ability = ABILITY_FLAME_BODY,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_FLAME_CHARGE, MOVE_THUNDER_PUNCH, MOVE_POWER_UP_PUNCH, MOVE_FIRE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .ability = ABILITY_STEAM_ENGINE,
    .nature = NATURE_CAREFUL,
    .moves = {MOVE_METEOR_BEAM, MOVE_OVERHEAT, MOVE_SCALD, MOVE_SCORCHING_SANDS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .ability = ABILITY_STORM_DRAIN,
    .nature = NATURE_QUIET,
    .moves = {MOVE_LEECH_SEED, MOVE_SUCKER_PUNCH, MOVE_GIGA_DRAIN, MOVE_HIDDEN_POWER_ICE}
    }
};
...
static const struct TrainerMon sParty_Celia[] = {
    ...
    .nature = NATURE_JOLLY,
    .moves = {MOVE_BODY_SLAM, MOVE_PSYCHIC_FANGS, MOVE_LOW_KICK, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .ability = ABILITY_WATER_ABSORB,
    .nature = NATURE_IMPISH,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_RECOVER, MOVE_BULLDOZE, MOVE_CHILLING_WATER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 31,
    ...
    .ability = ABILITY_FLASH_FIRE,
    .nature = NATURE_TIMID,
    .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_HIDDEN_POWER_ICE, MOVE_FIRE_SPIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_PURSUIT, MOVE_ROCK_SLIDE, MOVE_DRILL_RUN}
    }
};
...
static const struct TrainerMon sParty_Bryan[] = {
    ...
    .ability = ABILITY_LEVITATE,
    .nature = NATURE_QUIET,
    .moves = {MOVE_TRICK_ROOM, MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_DRAINING_KISS}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .ability = ABILITY_CHEEK_POUCH,
    .nature = NATURE_SASSY,
    .moves = {MOVE_RECYCLE, MOVE_FIRE_FANG, MOVE_SEED_BOMB, MOVE_RETURN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 32,
    ...
    .ability = ABILITY_OBLIVIOUS,
    .nature = NATURE_BRAVE,
    .moves = {MOVE_EARTH_POWER, MOVE_ICE_BEAM, MOVE_LIQUIDATION, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_Branden[] = {
    ...
    .ability = ABILITY_SAND_VEIL,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_TRIPLE_DIVE, MOVE_AQUA_JET, MOVE_FOCUS_ENERGY}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .ability = ABILITY_SAND_VEIL,
    .nature = NATURE_CALM,
    .moves = {MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_DARK_PULSE, MOVE_SPIKY_SHIELD}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 30,
    ...
    .ability = ABILITY_SAND_VEIL,
    .nature = NATURE_JOLLY,
    .moves = {MOVE_STOMPING_TANTRUM, MOVE_DRAGON_CLAW, MOVE_FIRE_FANG, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMon sParty_Melina[] = {
    ...
    .ability = ABILITY_TANGLED_FEET,
    .nature = NATURE_BRAVE,
    .moves = {MOVE_DIZZY_PUNCH, MOVE_BRICK_BREAK, MOVE_THUNDER_PUNCH, MOVE_STOMPING_TANTRUM}
    }
};
...
static const struct TrainerMon sParty_Aisha[] = {
    ...
    .ability = ABILITY_STURDY,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_SCALE_SHOT, MOVE_ROCK_CLIMB, MOVE_FIRE_FANG, MOVE_ZEN_HEADBUTT}
    }
};
...
static const struct TrainerMon sParty_Angelo[] = {
    ...
    .ability = ABILITY_SHED_SKIN,
    .nature = NATURE_ADAMANT,
    .moves = {MOVE_MEGA_DRAIN, MOVE_POISON_FANG, MOVE_ICE_FANG, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 25,
