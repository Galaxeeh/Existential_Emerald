...
const struct BattleBackground sBattleTerrainTable[] =
{
    ...
    [BATTLE_TERRAIN_SNOW] =
    {
        .tileset = gBattleTerrainTiles_SnowLongGrass,
        .tilemap = gBattleTerrainTilemap_SnowLongGrass,
        .entryTileset = gBattleTerrainAnimTiles_SnowLongGrass,
        .entryTilemap = gBattleTerrainAnimTilemap_SnowLongGrass,
        .palette = gBattleTerrainPalette_SnowLongGrass,
    },
};
